...
export async function getContact(req: NextApiRequest): Promise<[Response, ApiResponseType<IContact>]> {
...
export async function createContact(req: NextApiRequest) {
  const apiResponse = await apiRequest({ req, url: Endpoint.Contact, method: 'POST', body: req.body });
...
export async function updateContact(req: NextApiRequest) {
  const { id } = req.query;
  const apiResponse = await apiRequest({ req, url: `${Endpoint.Contact}/${id}`, method: 'PUT', body: req.body });
  const responseBody = await apiResponse.json();
  return [apiResponse, responseBody];
}
...
export async function createContactPhone(req: NextApiRequest) {
  const apiResponse = await apiRequest({ req, url: Endpoint.ContactPhone, method: 'POST', body: req.body });
  const responseBody = await apiResponse.json();
  return [apiResponse, responseBody];
}
...
export async function updateContactPhone(req: NextApiRequest) {
  const { id } = req.query;
  const apiResponse = await apiRequest({ req, url: `${Endpoint.ContactPhone}/${id}`, method: 'POST', body: req.body });
  const responseBody = await apiResponse.json();
  return [apiResponse, responseBody];
}
...
export async function deleteContactPhone(req: NextApiRequest) {
  const { id } = req.query;
  const apiResponse = await apiRequest({ req, url: `${Endpoint.ContactPhone}/${id}`, method: 'DELETE' });
  const responseBody = await apiResponse.json();
  return [apiResponse, responseBody];
}

export async function createContactEmail(req: NextApiRequest) {
  const apiResponse = await apiRequest({ req, url: Endpoint.ContactEmail, method: 'POST', body: req.body });
  const responseBody = await apiResponse.json();
  return [apiResponse, responseBody];
}
...
export async function updateContactEmail(req: NextApiRequest) {
  const { id } = req.query;
  const apiResponse = await apiRequest({ req, url: `${Endpoint.ContactEmail}/${id}`, method: 'POST', body: req.body });
  const responseBody = await apiResponse.json();
  return [apiResponse, responseBody];
}
...
export async function deleteContactEmail(req: NextApiRequest) {
  const { id } = req.query;
  const apiResponse = await apiRequest({ req, url: `${Endpoint.ContactEmail}/${id}`, method: 'DELETE' });
  const responseBody = await apiResponse.json();
  return [apiResponse, responseBody];
}