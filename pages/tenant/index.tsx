...
const TenantIndex = () => {
  ...
  const handleTabBarChange = (e: SyntheticEvent<Element, Event>, v: number | string) => {
    e.preventDefault();
  ...
  return (
    <Stack mt={12}>
      <Suspense>{openDialog && <AddTenantDialog open={openDialog} setOpen={setOpenDialog} />}</Suspense>
      <Box mb={5}>
        <Grid container>
