import { AccessTimeFilled, Cancel, CheckCircle, GppGood, PlayCircle, RemoveCircle } from '@mui/icons-material';
...
const FormStatusBooking: React.FC<IForStatusBookingProps> = ({ visible, onClose, booking, onUpdateState }) => {
